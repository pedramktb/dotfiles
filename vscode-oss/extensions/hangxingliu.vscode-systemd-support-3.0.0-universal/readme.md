...
![How to download nightly builds](https://github.com/hangxingliu/vscode-systemd/raw/HEAD/docs/images/download-nightly-builds.jpg)
...
Please check out the document [CONTRIBUTING.md](https://github.com/hangxingliu/vscode-systemd/blob/HEAD/docs/CONTRIBUTING.md) for information 
